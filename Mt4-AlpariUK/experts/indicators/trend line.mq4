...
Print("a1 ", ai_1, " a2 ", ai_2, " b1 ", bi_1, " b2 ", bi_2, " dh ", dh, " dl ", dl);
ObjectDelete("1 "+sName);
ObjectDelete("2 "+sName); 
ObjectCreate("1 "+sName,2, 0,Time[ai_2],High[ai_2],Time[ai_1],High[ai_1]);
ObjectCreate("2 "+sName,2, 0,Time[bi_2],Low[bi_2],Time[bi_1],Low[bi_1]);
return (0);
