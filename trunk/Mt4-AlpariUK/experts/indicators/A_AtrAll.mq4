...
//----
   for( int i = 0; i < cpn; i++) {
      ...
      ObjectSetText("KP"+i,CurrencyPairs[i] + "   DailyPercent : " + DoubleToStr( v, 5) + "  ATR : " 
                                                                                    + DoubleToStr( iATR( CurrencyPairs[i], PERIOD_D1, 1, 1) * 10000, 0) + " , " 
                                                                                    + DoubleToStr( iATR( CurrencyPairs[i], PERIOD_D1, ShortPeriod, 1) * 10000, 0) + " , " 
                                                                                    + DoubleToStr( iATR( CurrencyPairs[i], PERIOD_D1, LongPeriod, 1) * 10000, 0),9, "Arial Bold", objc);
      ObjectSet("KP"+i, OBJPROP_CORNER, 0);
      ObjectSet("KP"+i, OBJPROP_XDISTANCE, 100 + i / 15 * 600);
